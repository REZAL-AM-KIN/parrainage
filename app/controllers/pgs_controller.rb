...
class PgsController < ApplicationController
  ...
  skip_before_action :check_level_1, only: [:login, :beforelogin, :new, :create]
  skip_before_action :check_level_2, except: [:destroy, :check, :checkforverifx, :uncheckforverifx]
